...
#define PYTHON_BASE_TYPES                                                \
  int, bool, long, unsigned long, long long, unsigned long long, double, \
      std::complex<double>

#define PYTHON_STRING_TYPES const char*, std::string

#define PYTHON_ALL_TYPES PYTHON_BASE_TYPES, PYTHON_STRING_TYPES, pycpp::Object

// Types that we expect to fail
#define NONE_PYTHON_BASE_TYPES short, char, float, void
...
TEST(PythonTypeTraitsTests, TupleTypeTests) {
  constexpr auto testFullList =
      pycpp::isPythonBaseType_v<pycpp::Tuple<PYTHON_ALL_TYPES>>;
