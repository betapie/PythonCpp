...
pycpp::Object::Object(PyObject* pObject) noexcept : m_pObject(pObject) {}
...
pycpp::Object::~Object() { Release(); }

PyObject* pycpp::Object::get() const noexcept { return m_pObject; }

PyObject* pycpp::Object::operator->() const noexcept { return m_pObject; }

pycpp::Object::operator bool() const noexcept { return m_pObject != nullptr; }
...
// This method will on success yield the same result als the buildin repr()
// function in Python would. This can also fail. However, since this is needed
// to deduct Error::what() we will not throw here In the worst case, the
