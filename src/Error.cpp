...
pycpp::Error::Error() : std::runtime_error(RetrievePyErrorString()) {}

pycpp::Error::Error(const std::string& errMsg) : std::runtime_error(errMsg) {}

pycpp::Error::Error(const char* errMsg) : std::runtime_error(errMsg) {}
