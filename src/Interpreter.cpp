...
pycpp::detail::PyInstance::~PyInstance() { Py_Finalize(); }

pycpp::InterpreterHandle::InterpreterHandle() { Interpreter::Open(); }
...
pycpp::InterpreterHandle& pycpp::InterpreterHandle::operator=(
    const InterpreterHandle& other
) {
  if (_owns) {
    Interpreter::Close();
  }
...
bool pycpp::InterpreterHandle::Aqurired() noexcept { return _owns; }
