...
pycpp::Object pycpp::CallObject(
    const Object& callableObject, const Object& arglist
) {
  return CallObject(callableObject.get(), arglist.get());
}

pycpp::Callable::Callable(PyObject* pCallableObject) : Object(pCallableObject) {
  if (PyCallable_Check(m_pObject) != 1) {
    throw(Error("PyObject not callable"));
  }
}

pycpp::Callable::Callable(const Callable& other) : Object(other) {}
...
pycpp::Callable::Callable(Callable&& other) noexcept : Object(std::move(other)) {}
...
pycpp::Callable::Callable(const Object& other) : Object(other) {
