...
pycpp::Object pycpp::GetAttributeString(
    const Object& pObject, const char* attr_name
) {
  return GetAttributeString(pObject.get(), attr_name);
}

pycpp::Object pycpp::GetAttributeString(
    PyObject* pObject, const std::string& attr_name
) {
  return GetAttributeString(pObject, attr_name.c_str());
}

pycpp::Object pycpp::GetAttributeString(
    const Object& pObject, const std::string& attr_name
) {
