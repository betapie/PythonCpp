...
/*
    The Object class resembles the basic wrapper for owning a PyObject*. Any
   returned PyObject* that has ownership (participates in the ref count) for the
   pointed to object can be wrapped in a Object which will take care of the
   cleanup.
*/
