...
/*
    This is the header that should be included in your project. It makes sure
   that "Python.h" is included before any stl headers. This is important due to
   a few typedefs in "Python.h".
*/
