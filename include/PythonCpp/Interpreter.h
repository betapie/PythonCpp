...
/*
    This class resembles a handle to the Python interpreter which is created by
   PyInitialize(). There is only one interpreter which has to be shared among
   all uses of the Python C API. Use the Open() method to before any other
   Python related code. Close() when done. Opening multiple times will increase
   the ref count of the interpreter handle. If all clients close, Python will be
   finalized. Else Python will be finalized on destruction of the App.
*/
